...
import/websites/gr.maharashtra.gov.in/Planning:
	cd import/websites/gr.maharashtra.gov.in/ && ln -s $(GR_DIR)/Planning .
...
import: check_env import/websites/gr.maharashtra.gov.in/Planning .secrets/google.token 
	poetry run python import/src/build_documents.py import/websites/gr.maharashtra.gov.in/Planning import/documents
